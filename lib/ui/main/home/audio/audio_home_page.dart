...
import 'package:than_player/ui/main/home/audio/audio_current_jump_widget.dart';
...
class _AudioHomePageState extends State<AudioHomePage> {
  ...
  Widget showStyledList(List<AudioFile> list) {
    return AudioSliverList(
      list: list,
      onClicked: (file) {
        // print(file.meta.title?.isEmpty);
        AudioStateController.instance.setAudioList(list);
