...
import 'package:than_player/ui/main/home/video/video_folder_list_style_provider.dart';
...
import 'package:than_player/ui/main/home/video/video_folder_type_provider.dart';
  ...
  Widget videoListStyleWiget(VideoState state) {
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        ...
        return VideoListStylePageProvider(list: state.list);
      },
    );
  }
